    ...
    <script>
        $(document).ready(function() {
            ...
            $('#get_excel').click(function(event) {
                event.preventDefault();                
                window.open("report?action=fullExcelReport&uid=<?php echo (!empty($param['uid'])) ? $param['uid'] : '' ?>","_blank");
            });
        });
    </script>
    <body>
            ...
            ?>
                <table>
                    ...
                    <tr>
                        ...
                        <th>Part B Total</th><th>Combined Score</th><th>Submitted by Appraisee</th><th>Submitted by Appraising Officer</th><th>Finalized by Appraisee</th>
                        <th>Finalized by Appraising Officer</th><th>Confirmed by Countersigning Officer 1</th>
                    ...
                    <?php                         
                        ...
                        if (!empty($param['emptySurvey'])) {
                            foreach($param['emptySurvey'] as $username => $userData) {
                                echo "<tr>";
                                echo "<td>".$userData['staff_office']."</td>";
                                echo "<td>".$userData['staff_department']."</td>";
                                echo "<td>".$userData['staff_position']."</td>";
                                echo "<td>".$userData['staff_name']."</td>";
