<div id="content" class="wrapper">
    <div id="file-system">
        ...
        <?php } else { ?>
            <div class="wrapper">
                <?php
                // Echo all the folders
                    if (!empty($param["folder"])) {
                        foreach ($param["folder"] as $folderName => $folderInfo) { ?>
                        <a href='admin?action=documentView&path=<?php echo $param["path"] . "!" . $folderName; ?>' class='item-box'>
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px" viewBox="0 0 294.843 294.843" style="enable-background:new 0 0 294.843 294.843;" xml:space="preserve">
                                <g>
                ...
                // Echo all the files
                    if (!empty($param["file"])) {
                        foreach ($param["file"] as $fileName => $fileInfo) { ?>
                    <a href='admin?action=documentView&path=<?php echo $param["path"] . "!" . $fileName; ?>' class='item-box'>
