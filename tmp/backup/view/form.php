...
<script type="text/javascript">
    ...
    function getCountersignedScore(preCounterScore, countersigner1Score, countersigner2Score) {
        var result = null;
        var proportA = parseInt($('[name=countersigner_1_weight]').val());
        var proportB = parseInt($('[name=countersigner_2_weight]').val());
        if (isNaN(proportA) || isNaN(proportB)) {
            proportA = 50;
            proportB = 50;
            console.log('Warning : cannot get weight of countersigner 1 or 2. Assuming equal weight');
        }
        if (isNaN(countersigner1Score) && isNaN(countersigner2Score)) {
            result = preCounterScore;
        } else if (isNaN(countersigner2Score)) {
            result = (preCounterScore + countersigner1Score) / 2;
        } else if (isNaN(countersigner1Score)) {
            result = (preCounterScore + countersigner2Score) / 2;
        } else {
            result = preCounterScore/3 + (countersigner1Score * (proportA /(proportA + proportB)) + countersigner2Score * (proportB /(proportA + proportB)))*2/3
        }
    ...
    $(document).ready(function() {
        ...
        listeningElementA.change(function() {
            if ($(this).parsley().isValid()) {
                ...
                if (isAllFilled) {
                    ...
                    var result = getCountersignedScore(preCounterScore, countersigner1Score, countersigner2Score);
                }
        ...
        $(listeningElementB).change(function() {
            if ($(this).parsley().isValid()) {
                ...
                var result = getCountersignedScore(scoreFromAppraiser, parseFloat($('[name=countersigner_1_part_b_score]').val()), parseFloat($('[name=countersigner_2_part_b_score]').val()))
                    ...
                    <div class='part part_b' id='part_b1'>
                        ...
                        <div class='collectionContainer'>
                            <div class='collection overall_comments'>
                                ...
                                <textarea class='appraiser' name='part_b1_overall_comment' required></textarea>
                            </div>
                    ...
                    <div class='part part_b' id='part_b2'>
                        ...
                        <div class='collectionContainer'>
                            <div class='collection overall_comments'>
                                ...
                                <textarea class='appraiser' name='part_b2_overall_comment' required></textarea>
                            </div>                            
                            <div class='collection overall_score'>
                                <div class='collectionTitle'>
                                    Part B2 subtotal
